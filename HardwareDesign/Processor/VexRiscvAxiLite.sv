...
logic [ID_WIDTH-1:0]         i_s_axi_awid;
...
logic [ID_WIDTH-1:0]         i_s_axi_rid;
logic [DATA_WIDTH-1:0]       i_s_axi_rdata;
...
logic [ID_WIDTH-1:0]         d_s_axi_awid;
...
logic [DATA_WIDTH-1:0]       d_s_axi_wdata;
logic [STRB_WIDTH-1:0]       d_s_axi_wstrb;
logic                        d_s_axi_wlast;
logic                        d_s_axi_wvalid;
logic                        d_s_axi_wready;
logic [ID_WIDTH-1:0]         d_s_axi_bid;
logic [1:0]                  d_s_axi_bresp;
logic                        d_s_axi_bvalid;
logic                        d_s_axi_bready;
logic [ID_WIDTH-1:0]         d_s_axi_arid;
...
logic [ID_WIDTH-1:0]         d_s_axi_rid;
logic [DATA_WIDTH-1:0]       d_s_axi_rdata;
